...
export class MedicinePurchaseController {
  ...
  @Get('export/:id')
  async export(@Param('id', ParseIntPipe) id: string, @Res() res) {
    ...
    const headers = [
      ...
      {
        header: this.i18n.t('main.messages.purchase_medicine.purchase_number'),
        key: 'purchase_no',
        width: 30,
      },
      {
        header: this.i18n.t('main.messages.purchase_medicine.tax'),
        key: 'tax',
        width: 30,
      },
      {
        header: this.i18n.t('main.messages.purchase_medicine.discount'),
        key: 'discount',
        width: 30,
      },
      {
        header: this.i18n.t('main.messages.purchase_medicine.net_amount'),
        key: 'net_amount',
        width: 30,
      },
      {
        header: this.i18n.t('main.messages.purchase_medicine.payment_mode'),
        key: 'payment_mode',
        width: 30,
      },
    ];

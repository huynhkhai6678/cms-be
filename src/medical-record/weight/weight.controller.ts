...
export class WeightController {
  ...
  @Post()
  async create(
    @Body(ValidationPipe) createBloodPressureDto: CreateWeightDto,
    @Req() request: any,
  ) {
    const bloodPressure = await this.weightService.create(
  ...
  update(
    ...
    @Body(ValidationPipe) updateBloodPressureDto: UpdateWeightDto,
  ) {

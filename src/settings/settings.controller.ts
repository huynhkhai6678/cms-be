...
export class SettingsController {
  constructor(private readonly settingsService: SettingsService, private i18n: I18nService) {}
  ...
  @Post('general/:id')
  async updateGeneralSetting(@Param('id') id: string, @Body(new ValidationPipe()) updateSettingDto: UpdateGenralDto) {
  ...
  async updateContactInformation(@Param('id') id: string, @Body(new ValidationPipe()) updateSettingDto: UpdateContactInformationDto) {
